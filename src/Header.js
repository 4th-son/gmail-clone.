  ...
  return (
    <div className="header hidden md:flex justify-between border-b border-gray-300 sticky  ">
      <div className="header__left flex items-center">
        ...
        <img
          className="object-contain h-12 ml-1 hover:cursor-pointer"
          src="https://cdn.icon-icons.com/icons2/652/PNG/512/gmail_icon-icons.com_59877.png"
          alt=""
        />
        <h1 className=" text-3xl font-semibold text-black-900 mb-4 pt-3 pl-1 hover:cursor-pointer">
          Gmail
        </h1>
      </div>

      <div className="header__middle flex flex-none lg:w-7/12 h-12 items-center bg-zinc-200 p-3 rounded-full mt-2">
